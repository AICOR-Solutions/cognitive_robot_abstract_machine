...
class TestPoint2DConstruction:
    ...
    def test_reference_frame(self):
        ...
        p = Point2D(x=1, y=2, reference_frame=frame)
...
class TestPoint2DJSON:
    ...
    def test_to_json_symbolic_raises(self):
        p2 = Point2D(x=sm.FloatVariable(name="x"), y=0)
