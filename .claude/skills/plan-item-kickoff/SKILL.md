...
Step 7 opens the item's branch and draft pull request and records its
...
fail the skill: mention it in passing when presenting the plan (step 6) and
...
## 5. Resolve how this item gets started
...
Do this only once steps 1-4 are done. The recommendation is worth something
...
## 7. Bootstrap the item — before implementing, not after
...
## 8. Implement it — `auto` mode only

Work the plan step 6 settled, honoring the standing conventions step 4
